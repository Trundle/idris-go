...
goPreamble imports = T.unlines $
  ...
  , "  go Trampoline(MkThunk2(APPLY0, action, nil))"
  , "}"
  , ""
  ...
  , "}"
  , ""
  , "func GetFreelistItem(list *unsafe.Pointer, alloc func() unsafe.Pointer) unsafe.Pointer {"
  , "  for {"
  , "    h := *list"
  , "    if h == nil {"
  , "      return alloc()"
  , "    }"
  , "    if atomic.CompareAndSwapPointer(list, unsafe.Pointer(h), (*Freelist)(h).next) {"
  , "      return h"
  , "    }"
  , "  }"
  , "}"
  , ""
  , "func FreeItem(list *unsafe.Pointer, item unsafe.Pointer) {"
  , "  for {"
  , "    head := *list"
  , "    (*Freelist)(item).next = head"
  , "    if atomic.CompareAndSwapPointer(list, head, item) {"
  , "      break"
  , "    }"
  , "  }"
  , "}"
  ...
  , "  Run() (Thunk, unsafe.Pointer)"
  , "}"
  , ""
  , "type Thunk0 struct {"
  , "  f func() (Thunk, unsafe.Pointer)"
  , "}"
  , ""
  , "var freeThunk0s unsafe.Pointer"
  , ""
  , "func (t *Thunk0) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk0s, unsafe.Pointer(t))"
  , "  return t.f()"
  , "}"
  , "func AllocThunk0() unsafe.Pointer {"
  , "  return unsafe.Pointer(new(Thunk0))"
  , "}"
  , ""
  , "func MkThunk0(f func() (Thunk, unsafe.Pointer)) *Thunk0 {"
  , "  th := (*Thunk0)(GetFreelistItem(&freeThunk0s, AllocThunk0))"
  , "  th.f = f"
  , "  return th"
  , "}"
  , ""
  , "type Thunk1 struct {"
  , "  f func(unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  a unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk1) Run() (Thunk, unsafe.Pointer) {"
  , "  return t.f(t.a)"
  , "}"
  , ""
  , "func AllocThunk1() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk1))"
  , "}"
  , ""
  , "var freeThunk1s unsafe.Pointer"
  , ""
  , "func MkThunk1(f func(unsafe.Pointer) (Thunk, unsafe.Pointer), a unsafe.Pointer) *Thunk1 {"
  , "  th := (*Thunk1)(GetFreelistItem(&freeThunk1s, AllocThunk1))"
  , "  th.f = f"
  , "  th.a = a"
  , "  return th"
  , "}"
  , ""
  , "type Thunk2 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  a, b unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk2) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk2s, unsafe.Pointer(t))"
  , "  return t.f(t.a, t.b)"
  , "}"
  , ""
  , "func AllocThunk2() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk2))"
  , "}"
  , ""
  , "var freeThunk2s unsafe.Pointer"
  , ""
  , "func MkThunk2(f func(unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), a, b unsafe.Pointer) *Thunk2 {"
  , "  th := (*Thunk2)(GetFreelistItem(&freeThunk2s, AllocThunk2))"
  , "  th.f = f"
  , "  th.a = a"
  , "  th.b = b"
  , "  return th"
  ...
  , ""
  , "type Thunk3 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  a, b, c unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk3) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk3s, unsafe.Pointer(t))"
  , "  return t.f(t.a, t.b, t.c)"
  , "}"
  , ""
  , "func AllocThunk3() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk3))"
  , "}"
  , ""
  , "var freeThunk3s unsafe.Pointer"
  , ""
  , "func MkThunk3(f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), a, b, c unsafe.Pointer) *Thunk3 {"
  , "  th := (*Thunk3)(GetFreelistItem(&freeThunk3s, AllocThunk3))"
  , "  th.f = f"
  , "  th.a = a"
  , "  th.b = b"
  , "  th.c = c"
  ...
  , ""
  , "type Thunk4 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  a, b, c, d unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk4) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk4s, unsafe.Pointer(t))"
  , "  return t.f(t.a, t.b, t.c, t.d)"
  , "}"
  , ""
  , "func AllocThunk4() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk4))"
  , "}"
  , ""
  , "var freeThunk4s unsafe.Pointer"
  , ""
  , "func MkThunk4(f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), "
  , "              a, b, c, d unsafe.Pointer) *Thunk4 {"
  , "  th := (*Thunk4)(GetFreelistItem(&freeThunk4s, AllocThunk4))"
  , "  th.f = f"
  , "  th.a = a"
  , "  th.b = b"
  , "  th.c = c"
  ...
  , ""
  , "type Thunk5 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  a, b, c, d, e unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk5) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk5s, unsafe.Pointer(t))"
  , "  return t.f(t.a, t.b, t.c, t.d, t.e)"
  , "}"
  , ""
  , "func AllocThunk5() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk5))"
  , "}"
  , ""
  , "var freeThunk5s unsafe.Pointer"
  , ""
  , "func MkThunk5(f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), "
  , "              a, b, c, d, e unsafe.Pointer) *Thunk5 {"
  , "  th := (*Thunk5)(GetFreelistItem(&freeThunk5s, AllocThunk5))"
  , "  th.f = f"
  , "  th.a = a"
  , "  th.b = b"
  , "  th.c = c"
  ...
  , ""
  , "type Thunk6 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  _0, _1, _2, _3, _4, _5 unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk6) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk6s, unsafe.Pointer(t))"
  , "  return t.f(t._0, t._1, t._2, t._3, t._4, t._5)"
  , "}"
  , ""
  , "func AllocThunk6() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk6))"
  , "}"
  , ""
  , "var freeThunk6s unsafe.Pointer"
  , ""
  , "func MkThunk6(f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), "
  , "              _0, _1, _2, _3, _4, _5 unsafe.Pointer) *Thunk6 {"
  , "  th := (*Thunk6)(GetFreelistItem(&freeThunk6s, AllocThunk6))"
  , "  th.f = f"
  , "  th._0 = _0"
  , "  th._1 = _1"
  , "  th._2 = _2"
  ...
  , ""
  , "type Thunk7 struct {"
  , "  f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer)"
  , "  _0, _1, _2, _3, _4, _5, _6 unsafe.Pointer"
  , "}"
  , ""
  , "func (t *Thunk7) Run() (Thunk, unsafe.Pointer) {"
  , "  defer FreeItem(&freeThunk7s, unsafe.Pointer(t))"
  , "  return t.f(t._0, t._1, t._2, t._3, t._4, t._5, t._6)"
  , "}"
  , ""
  , "func AllocThunk7() unsafe.Pointer {"
  ,"   return unsafe.Pointer(new(Thunk7))"
  , "}"
  , ""
  , "var freeThunk7s unsafe.Pointer"
  , ""
  , "func MkThunk7(f func(unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer, unsafe.Pointer) (Thunk, unsafe.Pointer), "
  , "              _0, _1, _2, _3, _4, _5, _6 unsafe.Pointer) *Thunk7 {"
  , "  th := (*Thunk7)(GetFreelistItem(&freeThunk7s, AllocThunk7))"
  , "  th.f = f"
  , "  th._0 = _0"
  , "  th._1 = _1"
  , "  th._2 = _2"
...
exprToGo f RVal (SApp True name vs) = do
  ...
  let args = T.intercalate ", " (map lVarToGo vs)
      code = if trampolined
        then "__thunk = " `T.append` mkThunk name vs
...
exprToGo _ var (SApp False name vs) = do
  ...
  trampolined <- fmap ($ name) (gets requiresTrampoline)
  let call = if trampolined
        then "Trampoline(" `T.append` mkThunk name vs `T.append` ")"
        else sformat (stext % "(" % stext % ")") (nameToGo name) args
  return  [ Line (Just var) [ V i | (Loc i) <- vs ]
            (sformat (stext % " = " % stext) (varToGo var) call)
          ]
  where
...
mkThunk f [] = "MkThunk0(" `T.append` nameToGo f `T.append` ")"
mkThunk f args =
  sformat ("MkThunk" % int % "(" % stext % ", " % stext % ")")
